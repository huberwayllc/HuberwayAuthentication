...
const ConnectedAppsAlerts = () => {
  ...
  return (
    ...
    <div className='text-start d-felx justify-content-start mt-5 ms-4'>
        ...
        <p>Crea, gestisci e assegna la modalità di notifica da parte delle app connesse. Nota: le app appena installate devono essere aggiunte alle configurazioni di notifica</p>
